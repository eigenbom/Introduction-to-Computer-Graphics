...
public class BasicCube extends Frame implements GLEventListener, MouseMotionListener, WindowListener
{
	static GLU glu;
	static GLUT glut;
	...
	public BasicCube()
	{
		...
		// canvas.setGL(new TraceGL2(canvas.getGL(), System.err));
